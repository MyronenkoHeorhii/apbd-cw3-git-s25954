...
public sealed class LinqExercises
{
    ...
    {
        return UniversityData.Students.OrderBy(s => s.LastName)
    ...
    public IEnumerable<string> Task04_FirstAnalyticsCourse()
    {
        return UniversityData.Courses
            ...
            .DefaultIfEmpty("No Analytics course found");
    }
    ...
    public IEnumerable<string> Task05_IsThereAnyInactiveEnrollment()
    {
        ...
        bool result = UniversityData.Enrollments.Any(e => e.IsActive ==  false);
    ...
    {
        bool result = UniversityData.Lecturers.TrueForAll(l => l.Department != string.Empty);
    ...
    {
        return new List<string> { UniversityData.Enrollments.Count(e => e.IsActive == true).ToString() };
    ...
    {
        return UniversityData.Students.Select(s => s.City)
            .Distinct()
            .OrderBy(s => s);
    ...
    public IEnumerable<string> Task14_AverageGradePerCourse()
    {
        ...
        return UniversityData.Courses.Join(UniversityData.Enrollments,
            c => c.Id,
            e => e.CourseId,
            (c,e) => new {c, e})
            .Where(ec => ec.e.FinalGrade != null)
            .GroupBy(ec => ec.c.Title)
            .Select(g => $"{g.Key} {g.Average(ce => ce.e.FinalGrade)}" );
    ...
    public IEnumerable<string> Task15_LecturersAndCourseCounts()
    {
        ...
        return UniversityData.Lecturers.GroupJoin(UniversityData.Courses,
                ...
                c => c.LecturerId,
                (l, c) => new { l, c })
            .Select(lc => $"{lc.l.FirstName} {lc.l.LastName} {lc.c.Count()} ");
    ...
    public IEnumerable<string> Task16_HighestGradePerStudent()
    {
        ...
        return UniversityData.Students.GroupJoin(UniversityData.Enrollments,
            ...
            {
                se.s,
                g = se.e.Where(e => e.FinalGrade != null)
                    .Select(e => e.FinalGrade)

            })
            .Select(se => $"{se.s.FirstName} {se.s.LastName} {se.g.Max()}");
